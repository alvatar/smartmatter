...
ColorMap ColorMap::createSpectral() {
    ColorMap cm;
    cm.colors_.clear();
    cm.addColorLast(tgt::Color::red);
    cm.addColorLast(tgt::Color::yellow);
    cm.addColorLast(tgt::Color::green);
    cm.addColorLast(tgt::Color::blue);
    cm.setName("Spectral");
    return cm;
}
...
ColorMap ColorMap::createColdHot() {
    ...
    cm.colors_.clear();
    cm.addColorLast(tgt::Color::blue);
    cm.addColorLast(tgt::Color::white);
    cm.addColorLast(tgt::Color::red);
    cm.setName("Cold Hot");
    return cm;
}
...
ColorMap ColorMap::createGermany() {
    ColorMap cm;
    cm.colors_.clear();
    cm.addColorLast(tgt::Color::black);
    cm.addColorLast(tgt::Color::red);
    cm.addColorLast(tgt::Color (1, 0.6, 0, 1) );
    cm.setName("Germany");
    return cm;
}
...
ColorMap::ColorMap() {
    addColorLast(tgt::Color::black);
    addColorLast(tgt::Color::white);
}
