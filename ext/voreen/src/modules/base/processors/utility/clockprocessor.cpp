...
std::string ClockProcessor::getProcessorInfo() const {
    return "Performs clocking for time-based manipulation of properties in the network. "
           ...
           "This processor has neither any ports nor does it require any connections, instead "
           "it is used as a 'floating' processor in the networks, solely connected by property links.";
}
