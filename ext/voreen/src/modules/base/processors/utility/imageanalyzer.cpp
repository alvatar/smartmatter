...
std::string ImageAnalyzer::getProcessorInfo() const {
    return std::string("show some information about the image");
}

void ImageAnalyzer::initialize() throw (VoreenException) {
...
void ImageAnalyzer::deinitialize() throw (VoreenException) {
