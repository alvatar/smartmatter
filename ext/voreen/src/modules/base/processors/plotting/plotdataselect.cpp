...
const std::string PlotDataSelect::loggerCat_("voreen.plotting.PlotDataSelect");
...
std::string PlotDataSelect::getProcessorInfo() const {
    return std::string("Select, Sort or Filter the Data on the PlotData.inPort.");
}

void PlotDataSelect::initialize() throw (VoreenException) {
...
void PlotDataSelect::deinitialize() throw (VoreenException) {
