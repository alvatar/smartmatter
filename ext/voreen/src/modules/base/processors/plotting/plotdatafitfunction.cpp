...
std::string PlotDataFitFunction::getProcessorInfo() const {
    return std::string("interpolate the Data on the PlotData.inPort.");
}

void PlotDataFitFunction::initialize() throw (VoreenException) {
...
void PlotDataFitFunction::deinitialize() throw (VoreenException) {
