...
std::string GeometryRenderer::getProcessorInfo() const {
    return "Renders the passed geometry object with adjustable polygon mode "
           "and lighting settings. Additionally, a texture passed trough the "
           "render inport can be mapped onto the geometry (texture coordinates "
           "have to be set by the geometry object). ";
}
