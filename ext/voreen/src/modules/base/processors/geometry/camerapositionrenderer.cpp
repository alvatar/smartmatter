...
std::string CameraPositionRenderer::getProcessorInfo() const {
    return "Depicts the position of a camera in a 3D scene. "
           "The camera position to display is retrieved from the "
           "processor's camera property.";
}
