...
std::string QuadricRenderer::getProcessorInfo() const {
    return "Renders a GLU quadric. Currently supported: sphere and cylinder";
}

void QuadricRenderer::initialize() throw (VoreenException) {
