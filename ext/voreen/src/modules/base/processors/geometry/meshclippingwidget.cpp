...
void MeshClippingWidget::initialize() throw (VoreenException) {
...
std::string MeshClippingWidget::getProcessorInfo() const {
    return "3D control elements to manipulate an arbitrarily oriented mesh clipping plane. "
           "Use linking to connect the properties to a MeshClipping processor.";
}
